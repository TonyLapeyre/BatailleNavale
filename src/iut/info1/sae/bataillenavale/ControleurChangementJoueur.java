...
/** Établir un lien entre la vue demandeMDP.fxml 
 * et le modèle BatailleNavale
 * @author tony.lapeyre
 * @auhtor tom.jammes
 */
public class ControleurChangementJoueur {
    ...
    @FXML
    private static Text afficherNom;
    ...
    @FXML 
    void poursuiteJeu() {
        afficherNom.setText(BatailleNavale.nomJoueurNonActif());
        try {
